...
def update(frame):
    ...
    angular_velocity = PathPlanner3.calcAngularVelocity(path.target_angle, angle, angular_velocity, 10, 100, dt)
...
path = PathPlanner3.Path((((0, 0), 10, 0), ((5, 0), 10, np.pi/4), ((10, 5), 10, -np.pi/4), ((5, 10), 5, 0), ((5, 5), 5, 0), ((0, 10), 10, 0), ((5, 15), 10, 0), ((10, 15), 0, 0)), 10, 100, 25)
